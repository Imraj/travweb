...
{{Form::open(array("url"=>"admin/travelplan"))}}
  ...
  <div class="">
      <div class="form-group">
        ...
        {{Form::select("agency_id",$agency_options,$plan["agency_name"],array("class"=>"form-control"))}}
      </div>
      <div class="form-group">
        {{Form::label("location_id","Location ")}}
        {{Form::select("location_id",$location_options,$plan["location_name"],array("class"=>"form-control"))}}
      </div>
      <div class="form-group">
        {{Form::label("destination_id","Destination ")}}
        {{Form::select("destination_id",$location_options,$plan["destination_name"],array("class"=>"form-control"))}}
      </div>
      <div class="form-group">
          {{Form::label("price","Price ")}}
          {{Form::text("price",$plan["price"],array("class"=>"form-control","placeholder"=>"Price "))}}
      </div>
      ...
      <div class="form-group">
        ...
        {{Form::select("pickup_location",$pklocation_options,$plan["pickup_location"],array("class"=>"form-control"))}}
      </div>

      <div class="form-group">
        {{Form::label("dropoff_location","Drop Off Location ")}}
        {{Form::select("dropoff_location",$pklocation_options,$plan["dropoff_location"],array("class"=>"form-control"))}}
      </div>
