...
<head>
  ...
  <title>Route Administrator | </title>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
               <li><a> States <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                      <li><a href="{{ url('/route/state') }}">View All</a></li>
                      <li><a href="{{ url('/route/state/create') }}">Add New</a></li>
                  </ul>
                </li>
                <li><a> Locations / Cities <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                      <li><a href="{{ url('/route/location') }}">View All</a></li>
                      <li><a href="{{ url('/route/location/create') }}">Add New</a></li>
                  </ul>
                </li>
                <li><a>Routes / Directions  <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu" style="display: none">
                          <li><a href="{{ url('/route/direction') }}">View All</a></li>
                          <li><a href="{{ url('/route/direction/create') }}">Add New</a></li>
                      </ul>
                </li>
