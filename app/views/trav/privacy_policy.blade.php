...
<div class="row">
       ...
       <div class="container">
	<h3 class="title">Trav Privacy Policy</h3>
	<p>
		This privacy policy discloses the privacy practices for trav.com.ng and trav mobile apps. This privacy policy applies solely to information collected by this web site. It will notify you of the following:
		<ol>
	...
	<p>
		...
		<div>We are the sole owners of the information collected on this site. 
		We only have access to/collect information that you voluntarily give us 
		via email or other direct contact from you. We will not sell or rent this 
		information to anyone.</div><br/>
		...
		<div>Unless you ask us not to, we may contact you via email in the future 
		to tell you about specials, new features or services, or changes to this 
		privacy policy.</div>
	</p>
	...
	<h3>Registration</h3>
		...
		<div>To complete and finalize booking, a user must first complete the registration 
		form. During registration a user is required to give certain information 
		(such as name, phone number and email address). This information is used to contact you 
		about the services on our site in which you have expressed interest. 
		At your option, you may also provide next of kin information, 
	...
	<p>
		<h3>Bookings</h3> 
		<div>We request information from you on our order form. To book with us, 
		you must provide contact information and 
	...
	<h3>Updates</h3>
		...
		<br/>
		<div><b>If you feel that we are not abiding by this privacy policy, you should contact us immediately via email at contact@trav.com.ng </b>.</div>
	</p>
</div>
