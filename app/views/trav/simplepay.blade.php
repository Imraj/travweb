...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
   <div  style="color:black;">
      ...
      <div class="container">
        <div class="row">
              <div class="col-xs-6">
                <h4>Full Name : <span id="ss-dd-fullname">Kyle Trager<span></h4>
              </div>
          </div>
          <div class="row">
              <div class="col-xs-6">
                <h4>Email Address : <span id="ss-dd-emailAddress">ktrager@gmail.com</span></h4>
              </div>
          </div>
          <div class="row">
              <div class="col-xs-6">
                <h4>Phone Number : <span id="ss-dd-phoneNumber">2349033449024</span></h4>
              </div>
          </div>
   ...
   <div class="services-wrapper">
     <h3>Travel Details</h3>
        <div class="container">
            <div class="row">
                <div class="col-xs-6">
                  <span id="ss-dd-traveplan_id" class="text-hide">2</span>
                  <h4><span id="ss-dd-agency">Cross-state</span></h4>
                </div>
                 <div class="col-xs-4">
                  <h4>Price : N<span id="ss-dd-price">5000</span></h4>
                </div>
              </div>
              <div class="row">
                <div class="col-xs-6">
                  <h4><b>From:</b><span id="ss-dd-location">Yaba</span></h4>
                </div>
                <div class="col-xs-6">
                  <h4><b>To:</b><span id="ss-dd-destination">Abuja</span></h4>
                </div>
              </div>

              <div class="row">
                <div class="col-xs-12">
                  <h4><b>PickUp:</b><span id="ss-dd-pickup">test pickup address 1</span></h4>
                </div>
              </div>
              <div class="row">
                <div class="col-xs-12">
                  <h4><b>DropOff:</b>test drop address 1</h4>
                </div>

              </div>
              <div class="row">
                <div class="col-xs-4">
                  <h4><b>Take Off Date : 2016-01-30 </b></h4>
                </div>
                <div class="col-xs-4">
                  <h4><b>Take Off Time : 8:00am </b></h4>
                </div>
