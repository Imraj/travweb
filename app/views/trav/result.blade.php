...
{{Form::open(array("url"=>"/result"))}}
    <div class="row">
      <div class="col-xs-12">
        <div class="col-xs-3">
            {{Form::text("location","",array("id"=>"geocomplete1" ,"class"=>"form-control","placeholder"=>" To ","required"=>true))}}
        </div>
        <div class="col-xs-3">
            {{Form::text("destination","",array("id"=>"geocomplete2","class"=>"form-control","placeholder"=>" From ","required"=>true))}}
        </div>
        <div class="col-xs-2">
            <!-- Travel Date Starts-->
        ...
        <div class="col-xs-3">
          {{Form::submit("Search",array("id"=>"find","class"=>"btn btn-success btn-md col-xs-6" ))}}
        </div>
      </div>
    </div>
...
<div class="row">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
       <div class="services-wrapper">
          <div><b>Going From {{$location}} To {{$destination}} This Week</b></div>
      </div>
    </div>
    @elseif(count($results_suggestion) == 0)
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
       <div class="services-wrapper">
          <div><b>No Suggestion Found For {{$location}} To {{$destination}} This week </b></div>
      </div>
    </div>
    @endif
  ...
  @foreach($results as $result)
     <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        <div class="services-wrapper">
            ...
            <p>Take Off DateTime :  {{ $result["PickUp_DateTime"] }}</p>
