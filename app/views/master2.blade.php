...
<section id="contact" style="margin-top:115px;">
				...
				<div class="contact-wrapper">
					<div class="row">
						<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
							<img src="{{asset('assets/img/powered_horizontal_light.png')}}" class="col-xs-3 col-md-3 col-lg-3" />
						</div>
					...
					<div class="row">
						<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
							<img src="{{asset('assets/img/powered_horizontal_light.png')}}" />
						</div>
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
...
TrustLogo("https://trav.com.ng/home/assets/img/comodo_3.png", "CL1", "none");
</script>
